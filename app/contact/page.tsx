            ...
            <Card className="bg-white/10 backdrop-blur-sm border border-white/20 shadow-2xl">
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button type="submit" className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-3 rounded-xl shadow-lg hover:shadow-blue-500/25 transition-all duration-300">
                    Send Message
                  </Button>
                </form>
              </CardContent>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/80 text-base">+919958068502</p>
