      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-white text-blue-600 hover:bg-gray-100 px-8 py-3 cursor-pointer">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="bg-white text-blue-600 hover:bg-gray-100 px-8 py-3 cursor-pointer"
            >
